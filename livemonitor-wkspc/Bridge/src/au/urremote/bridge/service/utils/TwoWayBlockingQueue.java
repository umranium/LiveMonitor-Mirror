package au.urremote.bridge.service.utils;
...
public abstract class TwoWayBlockingQueue<InstanceType> {
	...
	private static final long POLLING_TIMEOUT = 3600000L;	// 1hr
	...
	public InstanceType takeFilledInstance() throws InterruptedException {
		return takeFilledInstance(POLLING_TIMEOUT);
	}
	
	public InstanceType takeFilledInstance(long timeOut) throws InterruptedException {
		InstanceType instance = filledInstances.poll(timeOut, TimeUnit.MILLISECONDS);
		if (instance==null)

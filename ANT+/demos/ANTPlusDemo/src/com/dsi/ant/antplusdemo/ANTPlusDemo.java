...
public class ANTPlusDemo extends Activity implements View.OnClickListener, AntPlusManager.Callbacks
{
   ...
   public void onCreate(Bundle savedInstanceState) 
   {
       ...
       //Sets up the ant service connection, and registers are callback functions with the class.
       mAntManager = new AntPlusManager(this, savedInstanceState, getApplicationContext(), this);
   ...
   public Object onRetainNonConfigurationInstance() 
   {
       ...
       return mAntManager.getAntReceiver();
   }

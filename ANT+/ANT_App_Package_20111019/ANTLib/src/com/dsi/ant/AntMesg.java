...
/**
 * Public API for controlling the ANT Radio Service. 
...
public class AntMesg {
	...
	public static final byte MESG_SYNC_SIZE                       =((byte)0);  // We do not include a sync byte at application level.
	...
	public static final byte MESG_CHECKSUM_SIZE                   =((byte)0);  // We do not include a checksum at application level.
